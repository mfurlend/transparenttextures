var raw_url  = 'https://raw.github.com/mfurlend/transparenttextures/master/',
    patterns = [],
    page     = 0,
    selector,
    selected;
...
chrome.extension.onMessage.addListener(function(message, info, cb) {
    if (message == 'getPatterns') {
        ...
        chrome.tabs.insertCSS({
                code: selector + ' { background-image:none !important; }'
        });
    }
...
patternsJSON.src = 'https://api.github.com/repos/mfurlend/transparenttextures/contents/?callback=loadPatterns'
